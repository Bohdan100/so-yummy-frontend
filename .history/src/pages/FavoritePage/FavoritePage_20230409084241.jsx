...
const FavoritePage = () => {
  ...
  // };
  const removeRecipeFromFavorites = async id => {
  ...
  const handleRemoveRecipe = async id => {
    const removedRecipe = await removeRecipeFromFavorites(id);
    setRecipes(recipes.filter(recipe => recipe.id !== removedRecipe.id));
  };
  return (
    <>
      {isLoading && <Loader />}
